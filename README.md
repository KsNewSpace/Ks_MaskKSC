...
- [Waterfall](https://github.com/post-kerbin-mining-corporation/Waterfall) (Framework! All new engine effects that expand with atmospheric pressure)
  ...
  - [Waterfall Expansion](https://spacedock.info/mod/3149/Restock%20Waterfall%20Expansion) (Closes the gab for some missing configs)
  - [RSMP](https://github.com/dangaffa/RSMP) (Configs for SRBs)
  - Alternative: [Stock Waterfall Effect](https://github.com/KnightofStJohn/StockWaterfallEffects) (Configs for stock engines - only use without Restock!!)
